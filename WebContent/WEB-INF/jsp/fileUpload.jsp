...
<body>
<br />
    <form action="${pageContext.request.contextPath }/fileUpload1.do"
    method="post" enctype="multipart/form-data" onsubmit="return check()">
	上传人：<input id="name" type="text" name="name" /><br /><br />
	请选择文件：<input id="file" type="file" name="uploadfile" 
                 multiple="multiple" accept=".doc,.docx"/><br /><br />
		       <input type="submit" value="上传" />
	</form>
	<script type="text/javascript" src="<%=basePath%>js/gui.js"></script> 
	<canvas id="can">
