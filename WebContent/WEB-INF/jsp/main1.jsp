  ...
  <div class="main">
    ...
    <div class="nav-user">      
      ...
      <a class="avatar" href="edituser.action">
        ...
        <cite style="color: white;">学生：${USER_SESSION.user_username}</cite>
	...
	<div class="main fly-user-main layui-clear">
		<ul class="layui-nav layui-nav-tree layui-inline" lay-filter="user">
			...
			<li class="layui-nav-item "><a href="${pageContext.request.contextPath }/me.do" target="right"> <i
					class="layui-icon">&#xe612;</i> 
					个人信息
					</a></li>
					<li class="layui-nav-item "><a href="${pageContext.request.contextPath }/homeworklist.do" target="right"> <i
					class="layui-icon">&#xe611;</i> 作业列表</a></li>	
			<li class="layui-nav-item "><a href="${pageContext.request.contextPath }/fileUpload.do" target="right"> <i
					class="layui-icon">&#xe611;</i> 提交作业</a></li>
				
				<li class="layui-nav-item "><a href="${pageContext.request.contextPath }/listCourse1.do" target="right"> <i
					class="layui-icon">&#xe61a;</i> 选修课程 </a></li>
				<li class="layui-nav-item "><a href="${pageContext.request.contextPath }/listCourse2.do" target="right"> <i
					class="layui-icon">&#xe61a;</i> 我的课表 </a></li>
